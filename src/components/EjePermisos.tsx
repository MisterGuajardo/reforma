...
const measures = [
  { number: "1", title: "Reduce plazo de invalidación de permisos sectoriales", whatItDoes: "Limita el plazo de invalidación de autorizaciones sectoriales de 2 años a 6 meses.", governmentClaim: "Reduce incertidumbre jurídica para proyectos de energía, minería, obras públicas y construcción.", risks: "Entre las críticas formuladas durante el debate público se encuentra que reduciría el plazo para impugnar actos administrativos y que podría debilitar el control ciudadano sobre permisos otorgados.", law: "Ley 19.880", articles: "Artículo 5°" },
  ...
  { number: "13", title: "Restitución de gastos por anulación de RCA", whatItDoes: "Si RCA favorable es anulada judicialmente, el titular tiene derecho a restitución de gastos directos.", governmentClaim: "Solo 2% de inversión ha sido revocada, pero el riesgo desincentiva proyectos.", risks: "Entre las críticas formuladas durante el debate público se encuentra que podría generar un efecto chilling sobre los tribunales ambientales, al modificar el principio de que el inversor asume el riesgo regulatorio.", law: "Ley 19.300", articles: "Artículos 14° a 18°" },
