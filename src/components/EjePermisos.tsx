...
const measures = [
  ...
  { number: "9", title: "RCA no reclamable por Ley 19.880", whatItDoes: "Solo recursos del responsable y de quienes participaron en la evaluación. No afecta recurso de protección constitucional.", governmentClaim: "Elimina recurso de invalidación que terceros pueden interponer hasta 2 años después de la RCA.", risks: "Algunos analistas señalan que podría restringir el acceso a la justicia ambiental. Comunidades sin representación durante la evaluación quedarían excluidas del proceso.", law: "Ley 19.300 / Ley 20.600", articles: "Artículo 13°, numerales 4, 5 y 6" },
  ...
  { number: "19", title: "Excepción Propiedad Intelectual para minería de datos", whatItDoes: "Excepción de licitud para uso de obras publicadas en análisis estadístico a gran escala, sin remuneración ni permiso.", governmentClaim: "Hoy usar obra protegida para entrenar IA es infracción. La ambigüedad legal dificulta el desarrollo de IA en Chile.", risks: "Organizaciones de creadores señalan que permitiría el uso no autorizado de obras para modelos de IA que compiten con los creadores, con posible infracción a tratados internacionales como ADPIC y TPP-11.", law: "Ley 17.336", articles: "Artículo 8°" },
];
