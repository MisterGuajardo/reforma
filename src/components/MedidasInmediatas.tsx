      ...
      <div className="section-padding py-20 lg:py-28">
        ...
        <div className="grid gap-6 lg:grid-cols-2 xl:grid-cols-3">
          <MeasureCard
            ...
            risks="Críticos: incentivo a elusión temporal — donaciones que se adelantan para aprovechar la rebaja, sin nuevo ingreso fiscal neto. La recaudación estimada es sobre capital que ya existe."
            law="Ley 16.271"
          ...
          <MeasureCard
            ...
            risks="Implica condonación parcial de deuda tributaria, reduciendo ingresos fiscales de corto plazo. Críticos lo ven como beneficio a deudores morosos."
          ...
          <MeasureCard
            ...
            risks="Renuncia a intereses y multas legalmente adeudados. Críticos: premia al moroso. Beneficia principalmente a grandes deudores comerciales."
          ...
          <div className="lg:col-span-2 xl:col-span-2">
            <MeasureCard
              ...
              risks="Críticos: incentivo a la elusión — utilidades retenidas tributarán solo 10% en vez de tasas marginales de hasta 44,45%. Beneficia principalmente a grandes contribuyentes."
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <MeasureCard
            ...
            risks="Costo fiscal: −$422.709 M (año 1) y −$614.356 M (año 2). Críticos: el beneficio puede ser capturado por los vendedores en vez de traspasarse a compradores."
          ...
          <MeasureCard
            ...
            risks="Críticos: es un nuevo impuesto donde antes no existía — hoy las viviendas económicas están exentas. El límite de 90 m² puede excluir proyectos familiares."
