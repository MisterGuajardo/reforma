      ...
      <div className="section-padding py-20 lg:py-28">
        ...
        <div className="grid gap-6 lg:grid-cols-2 xl:grid-cols-3">
          <MeasureCard
            ...
            risks="Algunos analistas señalan que incentivo a elusión temporal — donaciones que se adelantan para aprovechar la rebaja, sin nuevo ingreso fiscal neto. La recaudación estimada es sobre capital que ya existe."
            law="Ley 16.271"
          ...
          <MeasureCard
            ...
            risks="Implica condonación parcial de deuda tributaria, reduciendo ingresos fiscales de corto plazo. Algunos analistas lo ven como un beneficio para deudores morosos."
          ...
          <MeasureCard
            ...
            risks="Renuncia a intereses y multas legalmente adeudados. Algunos analistas señalan que premia al moroso y que el beneficio se concentraría en grandes deudores comerciales."
          ...
          <div className="lg:col-span-2 xl:col-span-2">
            <MeasureCard
              ...
              risks="Algunos analistas señalan que crearía un incentivo a la elusión — utilidades retenidas tributarían solo 10% en vez de tasas marginales de hasta 44,45% — y que el beneficio se concentraría en grandes contribuyentes."
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <MeasureCard
            ...
            risks="Costo fiscal: −$422.709 M (año 1) y −$614.356 M (año 2). Algunos analistas señalan que existe el riesgo de que el beneficio sea capturado por los vendedores en vez de traspasarse a compradores."
          ...
          <MeasureCard
            ...
            risks="Algunos analistas señalan que crearía un impuesto donde antes no existía — hoy las viviendas económicas están exentas — y que el límite de 90 m² podría excluir proyectos de tipo familiar."
