      ...
      <div className="section-padding py-20 lg:py-28">
        ...
        <div className="grid gap-6 lg:grid-cols-2 xl:grid-cols-3">
          <MeasureCard
            ...
            risks="Críticos: limita acceso de estudiantes de menores ingresos. Beneficia a IES establecidas al restringir competencia. Sin fecha de reapertura clara."
            law="Ley 21.091"
          ...
          <MeasureCard
            ...
            risks="Críticos: eleva umbrales significativamente respecto a la ley actual (23,5%). Posterga gratuidad universal por décadas, pues el PIB tendencial no minero rara vez supera 30%."
            law="Ley 21.091"
